...
Dim retVal As Long
Public Sub CargarInt()
Open App.Path & ("\log1.ini") For Binary As #1
Get #1, 1, a1
Minecraft.Int.World1(0).Caption = a1
Close #1
Open App.Path & ("\log2.ini") For Binary As #2
Get #2, 2, a2
Minecraft.Int.World1(1).Caption = a2
Close #2
Open App.Path & ("\log3.ini") For Binary As #3
Get #3, 3, a3
Minecraft.Int.World1(2).Caption = a3
Close #3
'Get #2, 4, a4
'Minecraft.Int.World1(3).Caption = a4
'Get #2, 5, a5
'Minecraft.Int.World1(4).Caption = a5
'Get #2, 6, a6
'Minecraft.Int.World1(5).Caption = a6
'Get #2, 7, a7
'Minecraft.Int.World1(6).Caption = a7
'Get #2, 8, a8
'Minecraft.Int.World1(7).Caption = a8
'Get #2, 9, a9
'Minecraft.Int.World1(8).Caption = a9
'Get #2, 10, a10
'Minecraft.Int.World1(9).Caption = a10
'Get #2, 11, b1
'Minecraft.Int.Seed1(0).Caption = b1
'get #2, 12, b2
'minecraft.Int.Seed1(1).Caption = b2
'get #2, 13, b3
'minecraft.Int.Seed1(2).Caption = b3
'get #2, 14, b4
'minecraft.Int.Seed1(3).Caption = b4
'get #2, 15, b5
'minecraft.Int.Seed1(4).Caption = b5
'get #2, 16, b6
'minecraft.Int.Seed1(5).Caption = b6
'get #2, 17, b7
'minecraft.Int.Seed1(6).Caption = b7
'get #2, 18, b8
'minecraft.Int.Seed1(7).Caption = b8
'get #2, 19, b9
'minecraft.Int.Seed1(8).Caption = b9
'get #2, 20, b4
'minecraft.Int.Seed1(9).Caption = b10
Close #2
End Sub
Public Sub GuardarInt()
Open App.Path & ("\log1.ini") For Binary As #1
a1 = Minecraft.Int.World1(0).Caption
Put #1, 1, a1
Close #1
Open App.Path & ("\log2.ini") For Binary As #2
a2 = Minecraft.Int.World1(1).Caption
Put #2, 2, a2
Close #2
Open App.Path & ("\log3.ini") For Binary As #3
a3 = Minecraft.Int.World1(2).Caption
Put #3, 3, a3
Close #3
'a4 = Minecraft.Int.World1(3).Caption
'put #2, 4, a4
'a5 = Minecraft.Int.World1(4).Caption
'put #2, 5, a5
'a6 = Minecraft.Int.World1(5).Caption
'put #2, 6, a6
'a7 = Minecraft.Int.World1(6).Caption
'put #2, 7, a7
'a8 = Minecraft.Int.World1(7).Caption
'put #2, 8, a8
'a9 = Minecraft.Int.World1(8).Caption
'put #2, 9, a9
'a10 = Minecraft.Int.World1(9).Caption
'put #2, 10, a10
'b1 = Minecraft.Int.Seed1(0).Caption
'put #2, 11, 'b1
'b2 = Minecraft.Int.Seed1(1).Caption
'put #2, 12, 'b2
'b3 = Minecraft.Int.Seed1(2).Caption
'put #2, 13, 'b3
'b4 = Minecraft.Int.Seed1(3).Caption
'put #2, 14, 'b4
'b5 = Minecraft.Int.Seed1(4).Caption
'put #2, 15, 'b5
'b6 = Minecraft.Int.Seed1(5).Caption
'put #2, 16, 'b6
'b7 = Minecraft.Int.Seed1(6).Caption
'put #2, 17, 'b7
'b8 = Minecraft.Int.Seed1(7).Caption
'put #2, 18, 'b8
'b9 = Minecraft.Int.Seed1(8).Caption
'put #2, 19, 'b9
'b10 = Minecraft.Int.Seed1(9).Caption
'put #2, 20, 'b10
Close #2
End Sub
Public Sub Saltar()
...
If Hlp.Text1.Caption = Minecraft.Options.z.Text Then
For Index = 70 To 711
If Juego.block(Index) = Hlp.Image3.Picture Or Juego.block(Index) = Hlp.Image4.Picture Or Juego.block(Index) = Hlp.Image4a.Picture Then
...
For a1s = 0 To 7
    For tt = 0 To 63
        For c = 0 To 7
            ...
            If InvCraft.c(c).BorderStyle = 1 Then InvCraft.c(c).BorderStyle = 0
...
Saltar
End If
If Hlp.Text1.Caption = Minecraft.Options.c.Text Then
CONSTRUCCION
Hlp.Text1.Caption = ""
End If
End Sub
...
Public Sub Play1()
For Index = 0 To 9
If Minecraft.Int.World1(Index).BackColor = &H8000000D Then
Minecraft.Int.Hide
Load Hlp
Juego.Show
End If
...
'Get #1, 1, j
'If j = 7 Then Juego.block(533) = Sob.Image7.Picture
'Close #1
'End Sub
Public Sub Rename1()
...
If Hlp.Text1.Caption = Minecraft.Options.e.Text Then
Hlp.Text1.Caption = ""
...
If Hlp.Text1.Caption = Minecraft.Options.r.Text Then
Hlp.Text1.Caption = ""
 For Index = 0 To 7
 ...
 For Index = 0 To 6
  ...
  End If
 Next Index
    If InvCraft.inv(1).BorderStyle = 0 And InvCraft.inv(25).BorderStyle = 0 And InvCraft.inv(49).BorderStyle = 0 And InvCraft.inv(2).BorderStyle = 0 And InvCraft.inv(26).BorderStyle = 0 And InvCraft.inv(50).BorderStyle = 0 And InvCraft.inv(3).BorderStyle = 0 And InvCraft.inv(27).BorderStyle = 0 And InvCraft.inv(51).BorderStyle = 0 And InvCraft.inv(4).BorderStyle = 0 And InvCraft.inv(28).BorderStyle = 0 And InvCraft.inv(52).BorderStyle = 0 _
    And InvCraft.inv(5).BorderStyle = 0 And InvCraft.inv(29).BorderStyle = 0 And InvCraft.inv(53).BorderStyle = 0 And InvCraft.inv(6).BorderStyle = 0 And InvCraft.inv(30).BorderStyle = 0 And InvCraft.inv(54).BorderStyle = 0 And InvCraft.inv(7).BorderStyle = 0 And InvCraft.inv(31).BorderStyle = 0 And InvCraft.inv(55).BorderStyle = 0 And InvCraft.inv(8).BorderStyle = 0 And InvCraft.inv(32).BorderStyle = 0 And InvCraft.inv(56).BorderStyle = 0 _
    And InvCraft.inv(9).BorderStyle = 0 And InvCraft.inv(33).BorderStyle = 0 And InvCraft.inv(57).BorderStyle = 0 And InvCraft.inv(10).BorderStyle = 0 And InvCraft.inv(34).BorderStyle = 0 And InvCraft.inv(58).BorderStyle = 0 And InvCraft.inv(11).BorderStyle = 0 And InvCraft.inv(35).BorderStyle = 0 And InvCraft.inv(59).BorderStyle = 0 And InvCraft.inv(12).BorderStyle = 0 And InvCraft.inv(36).BorderStyle = 0 And InvCraft.inv(60).BorderStyle = 0 _
    And InvCraft.inv(13).BorderStyle = 0 And InvCraft.inv(37).BorderStyle = 0 And InvCraft.inv(61).BorderStyle = 0 And InvCraft.inv(14).BorderStyle = 0 And InvCraft.inv(38).BorderStyle = 0 And InvCraft.inv(62).BorderStyle = 0 And InvCraft.inv(15).BorderStyle = 0 And InvCraft.inv(39).BorderStyle = 0 And InvCraft.inv(63).BorderStyle = 0 And InvCraft.inv(16).BorderStyle = 0 And InvCraft.inv(40).BorderStyle = 0 _
    And InvCraft.inv(17).BorderStyle = 0 And InvCraft.inv(41).BorderStyle = 0 And InvCraft.inv(18).BorderStyle = 0 And InvCraft.inv(42).BorderStyle = 0 And InvCraft.inv(19).BorderStyle = 0 And InvCraft.inv(43).BorderStyle = 0 And InvCraft.inv(20).BorderStyle = 0 And InvCraft.inv(44).BorderStyle = 0 Then Auto
    
End If
End Sub
Public Sub AbrirInventario1()
If Hlp.Text1.Caption = Minecraft.Options.i.Text Then
Juego.Hide
InvCraft.Show
Hlp.Text1.Caption = ""
MesaI
...
For ex = 0 To 9
If Minecraft.Int.World1(ex).BackColor = &H8000000D Then
Juego.Caption = Minecraft.Int.World1(ex).Caption
Hlp.hlp1 = Sob.Image73.Picture
Hlp.hlp2 = Sob.Image73.Picture
''BLOQUE SEMILLA''
If Minecraft.Int.Seed1(ex).Caption <> "0" Then
...
For x = 0 To 781
''Open the craftbox
If Juego.block(x).BorderStyle = 1 And Juego.block(x) = Sob.Image77.Picture Then
   Juego.Hide
   InvCraft.Show
   MesaC
End If
...
For cix = 0 To 63
 ...
 For vn = 0 To 8
  If InvCraft.imgh(Index).BorderStyle = 1 And InvCraft.inv(cix).BorderStyle = 1 Then
        If Hlp.cvb22.Caption = "i" Then
            ...
            If InvCraft.Decharge.Value = True Then
                ...
                If InvCraft.imgh(Index) = Hlp.Vacio.Picture And InvCraft.inv(cix) <> Hlp.Vacio.Picture Then
                   ...
                   iio# = hg41a \ 2
                   ipp# = hg41a - iio
                   InvCraft.imgh(Index).Tag = iio
                   InvCraft.inv(cix).Tag = iip
                   InvCraft.imgh(Index).BorderStyle = 0
                   InvCraft.inv(cix).BorderStyle = 0
                End If
    ...
    If Hlp.cvb22.Caption = "a" Then
         If InvCraft.Decharge.Value = True Then
             ...
             cvb76# = asd46 \ 2
             cvb77# = asd46 - cvb76
             InvCraft.imgh(Index).Tag = cvb77
             InvCraft.inv(cix).Tag = cvb76
             InvCraft.imgh(Index).BorderStyle = 0
             InvCraft.inv(cix).BorderStyle = 0
             End If
  ...
  End If
    ''For Craft
    If InvCraft.imgh(Index).BorderStyle = 0 And InvCraft.inv(cix).BorderStyle = 1 And InvCraft.c(vn).BorderStyle = 1 And InvCraft.inv(cix) <> Hlp.Vacio.Picture Then   'And invcraft.inv(cix).Tag >= 1
      InvCraft.c(vn) = InvCraft.inv(cix).Picture
      a# = InvCraft.inv(cix).Tag
      InvCraft.inv(cix).Tag = a - 1
      InvCraft.c(vn).Tag = "1"
      InvCraft.c(vn) = InvCraft.inv(cix).Picture
      InvCraft.inv(cix).BorderStyle = 0
      InvCraft.c(vn).BorderStyle = 0
    End If
    'If InvCraft.imgh(Index).BorderStyle = 1 And InvCraft.inv(cix).BorderStyle = 0 And InvCraft.c(vn).BorderStyle = 1 Then
     '
    'End If
...
End Sub
Public Sub MesaI()
InvCraft.c(0).Visible = True
InvCraft.c(1).Visible = True
InvCraft.c(2).Visible = False
InvCraft.c(3).Visible = True
InvCraft.c(4).Visible = True
InvCraft.c(5).Visible = False
InvCraft.c(6).Visible = False
InvCraft.c(7).Visible = False
InvCraft.c(8).Visible = False
End Sub
Public Sub MesaC()
InvCraft.c(0).Visible = True
InvCraft.c(1).Visible = True
InvCraft.c(2).Visible = True
InvCraft.c(3).Visible = True
InvCraft.c(4).Visible = True
InvCraft.c(5).Visible = True
InvCraft.c(6).Visible = True
InvCraft.c(7).Visible = True
InvCraft.c(8).Visible = True
End Sub
Public Sub Limpiar()
For cix = 0 To 63
    If InvCraft.inv(cix).Tag <= 0 Then InvCraft.inv(cix) = Hlp.Vacio.Picture
Next cix
End Sub
Public Sub VaciarMesa()
For Index = 0 To 63
For vn = 0 To 7
For cix = 0 To 7
''For De-Craft
    If InvCraft.imgh(cix).BorderStyle = 0 And InvCraft.inv(Index).BorderStyle = 1 And InvCraft.c(vn).BorderStyle = 1 And InvCraft.c(vn) <> Hlp.Vacio.Picture Then   'And invcraft.inv(cix).Tag >= 1
      ''Si el bloque-inventario está vacío
      If InvCraft.inv(Index) = Hlp.Vacio.Picture Then
        InvCraft.inv(Index) = InvCraft.c(vn).Picture
        InvCraft.inv(Index).Tag = "1"
        InvCraft.c(vn) = Hlp.Vacio.Picture
        InvCraft.c(vn).Tag = "0"
        VaciarMarcas
      End If
      ''Si el bloque-inventario le corresponde (debido a la igualdad de la propiedad Picture)
      If InvCraft.inv(Index) = InvCraft.c(vn).Picture Then
        InvCraft.c(vn) = Hlp.Vacio.Picture
        InvCraft.c(vn).Tag = "0"
        qwe1# = InvCraft.inv(Index).Tag
        InvCraft.inv(Index).Tag = qwe1 + 1
        VaciarMarcas
      End If
...
End Sub
Public Sub VaciarMarcas()
For Index = 0 To 63
    For vn = 0 To 7
        For cix = 0 To 7
            If InvCraft.inv(Index).BorderStyle = 1 Then InvCraft.inv(Index).BorderStyle = 0
            If InvCraft.c(vn).BorderStyle = 1 Then InvCraft.c(vn).BorderStyle = 0
            If InvCraft.imgh(cix).BorderStyle = 1 Then InvCraft.imgh(cix).BorderStyle = 0
        Next cix
    Next vn
Next Index
End Sub
Public Sub GotFocuss()
If Hlp.tmCraft.Enabled = False Then
For Index = 0 To 7


''Tablones de roble
If InvCraft.c(Index) = Sob.Image6.Picture Then
InvCraft.r = Sob.Image8.Picture
InvCraft.r.Tag = "4"
InvCraft.rc.Caption = InvCraft.r.Tag


End If
''Tablones de pino
If InvCraft.c(Index) = Sob.Image7.Picture Then
InvCraft.r = Sob.Image9.Picture
InvCraft.r.Tag = "4"
InvCraft.rc.Caption = InvCraft.r.Tag
...
''Mesa de creación
'1
If InvCraft.c(Index) = Sob.Image9.Picture Then
If InvCraft.c(Index + 1) = Sob.Image9.Picture And InvCraft.c(Index + 3) = Sob.Image9.Picture And InvCraft.c(Index + 4) = Sob.Image9.Picture Then
InvCraft.r = Sob.Image77.Picture
InvCraft.r.Tag = "1"
InvCraft.rc.Caption = InvCraft.r.Tag
...
End If
'2
If InvCraft.c(Index) = Sob.Image8.Picture Then
If InvCraft.c(Index + 1) = Sob.Image8.Picture And InvCraft.c(Index + 3) = Sob.Image8.Picture And InvCraft.c(Index + 4) = Sob.Image8.Picture Then
InvCraft.r = Sob.Image77.Picture
InvCraft.r.Tag = "1"
InvCraft.rc.Caption = InvCraft.r.Tag
...
InvCraft.r.Tag = "4"
InvCraft.rc.Caption = InvCraft.r.Tag
InvCraft.c(Index) = Hlp.Vacio.Picture
InvCraft.c(Index).Tag = "0"
End If
''Tablones de pino
If InvCraft.c(Index) = Sob.Image7.Picture Then
InvCraft.r = Sob.Image9.Picture
...
InvCraft.r.Tag = "1"
InvCraft.rc.Caption = InvCraft.r.Tag
InvCraft.c(Index + 1) = Hlp.Vacio.Picture
InvCraft.c(Index + 3) = Hlp.Vacio.Picture
InvCraft.c(Index + 4) = Hlp.Vacio.Picture
InvCraft.c(Index) = Hlp.Vacio.Picture
InvCraft.c(Index + 1).Tag = "0"
InvCraft.c(Index + 3).Tag = "0"
InvCraft.c(Index + 4).Tag = "0"
InvCraft.c(Index).Tag = "0"
End If
End If
'2
